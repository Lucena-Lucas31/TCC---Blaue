        ...
        <div class="navbar">
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li style="border: 2.5px solid var(--selpage-color); border-radius: 10px; padding: 5px;"><a href="jogologado.php" style="text-decoration: none;">JOGO</a></li>
            ...
            <div class="container-principal">
                ...
                <div >
                    <a href="http://localhost:8081/"><button class="jogarbtn"> IR PARA O JOGO ></button></a>
                </div>
