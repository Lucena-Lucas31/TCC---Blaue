        ...
        <div class="navbar">
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li style="border: 2.5px solid var(--selpage-color); border-radius: 10px; padding: 5px;"><a href="sobre.php" style="text-decoration: none;">SOBRE</a></li>
            ...
            <div class="container-principal">
                ...
                <div class="texts">
                    ...
                    <div class="text-3">
                        <p>A TechnoBlaue foi criada para desenvolver aquilo que você precisa no seu dia a dia. Nossas pesquisas são feitas com especialistas no caso e desenvolvidas a partir da sua necessidade, buscamos sempre auxiliar em tratamentos médicos e no seu bem estar e lazer durante sua jornada.</p>
                    </div>

                    <div class="text-4">
                        <strong><h1>PESQUISA CIENTÍFICA</h1></strong>
                    </div>

                    <div class="text-5">
                        <p>O jogo "Ajude o Alzhy" tem como base pesquisa realizada com neurologista, a quem agradecemos o apoio e a ajuda, Doutor Aston da Rede D'Or São Luiz. Também nos baseamos na pesquisa feita pela Unifesp, em que jogos digitais auxiliam nas funções cognitivas, logo ajudando a combater as doenças degenerativas cerebrais.</p>
                        <p style="padding-top: 0.9vw;"><strong>Acesse nossas fontes abaixo:</strong></p>
                    </div>

                </div>

                <div>
                    <a href="https://sp.unifesp.br/epm/noticias/estudo-da-unifesp-revela-como-jogos-digitais-podem-contribuir-cognitivamente-para-o-envelhecimento-saudavel" target="blank">
                        <button class="btnunifesp" type="button"><img src="../SITETECHNOBLAUE/images/papelunifesp.png" alt="ilustration" class="papelunifesp" id="papel"><strong><p>UNIFESP</p></strong></button>
                    </a>
                </div>

                <div>
                    <a href="https://www.rededorsaoluiz.com.br/encontre-um-medico/perfil/aston-marques-midon" target="blank">
                        <button class="btndoutor"><img src="../SITETECHNOBLAUE/images/dr.png" alt="ilustration" class="imgdr" id="dr"><strong><p>DOUTOR ASTON</p></strong></button>
                    </a>
                </div>

                <img src="../SITETECHNOBLAUE/images/veia 1.png" alt="ilustration" class="veia">

                <img src="../SITETECHNOBLAUE/images/prancheta.png" alt="ilustration" class="imgpapel" id="prancheta">
                ...
                <a href="psi.php"><span class="openPsiSobre" title="Políticas de Segurança"> ACESSE NOSSA POLÍTICA DE SEGURANÇA </span></a>
