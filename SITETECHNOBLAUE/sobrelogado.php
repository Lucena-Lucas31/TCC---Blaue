        ...
        <div class="navbar">
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li style="border: 2.5px solid var(--selpage-color); border-radius: 10px; padding: 5px;"><a href="sobrelogado.php" style="text-decoration: none;">SOBRE</a></li>
            ...
            <div class="container-principal">
                ...
                <div >
                    <a href="https://sp.unifesp.br/epm/noticias/estudo-da-unifesp-revela-como-jogos-digitais-podem-contribuir-cognitivamente-para-o-envelhecimento-saudavel" target="blank">
                        <button class="btnunifesp"><img src="../SITETECHNOBLAUE/images/papelunifesp.png" alt="ilustration" class="papelunifesp" id="papel"><strong><p>UNIFESP</p></strong></button>
                    </a>
                </div>

                <div >
                    <a href="https://www.rededorsaoluiz.com.br/encontre-um-medico/perfil/aston-marques-midon" target="blank"><button class="btndoutor"><img src="../SITETECHNOBLAUE/images/dr.png" alt="ilustration" class="imgdr" id="dr"><strong><p>DOUTOR ASTON</p></strong></button></a>
                </div>
